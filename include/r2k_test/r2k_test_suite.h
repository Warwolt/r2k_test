...
#define TEST_SUITE_START() if (r2k_should_skip_suite(__func__, r2k_internal_get_test_runner()->test_filter)) return; r2k_test_suite_t R2K_TEST_SUITE = r2k_test_suite_start(__func__)
